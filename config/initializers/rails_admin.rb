# RailsAdmin config file. Generated on June 02, 2014 16:45
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Curio', 'Admin']
  ...
  # config.excluded_models = ['Company', 'Product']

  # Include specific models (exclude the others):
  # config.included_models = ['Company', 'Product']
